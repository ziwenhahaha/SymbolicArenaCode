...
def main(cfg):
  ...
  #      resume_from_checkpoint='/local/home/anonymous/NeuralSymbolicRegressionThatScales/run/True/2021-05-27/12-18-49/Exp_weights/100000000_log_-epoch=00-val_loss=0.81.ckpt'
    )
