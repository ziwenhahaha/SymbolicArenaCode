...
class Evaluator(object):
    ...
    def evaluate_pmlb(
        ...
        all_datasets = pd.read_csv(
            "/private/home/anonymous/Research_2/symbolicregression/datasets/pmlb_description.tsv",
            sep="\t",
        )
        ...
        pmlb_path = "/private/home/anonymous/Research_2/pmlb/all_datasets/"  # high_dim_datasets

        feynman_problems = pd.read_csv(
            "/private/home/anonymous/Research_2/symbolicregression/datasets/FeynmanEquations.csv",
            delimiter=",",
        )
